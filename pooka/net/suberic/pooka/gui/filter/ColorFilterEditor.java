...
public class ColorFilterEditor extends FilterEditor implements java.awt.event.ActionListener {
	...
	String origRgbString = sourceBundle.getProperty(propertyName + ".rgb", Integer.toString(NO_VALUE));
	...
	if (newValue != originalRgb)
	    sourceBundle.setProperty(property + ".rgb", Integer.toString(newValue));
